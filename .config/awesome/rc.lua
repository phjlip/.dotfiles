...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Mod1"    }, "o", 
              function ()
                  awful.spawn(terminal, { tag = awful.screen.focused().tags[1] })
                  awful.spawn("qutebrowser", { tag = awful.screen.focused().tags[1] })
                  awful.spawn("emacs", { tag = awful.screen.focused().tags[2] })
                  awful.spawn("brave", { tag = awful.screen.focused().tags[3] })
              end,
              {description = "open working environment", group = "launcher"}),
    ...
    awful.key({ modkey, "Mod1"    }, "q", 
              ...
              {description = "close all open clients", group = "client"}),
...
clientkeys = gears.table.join(
    ...
    --[[ awful.key({ modkey, "Shift"   }, ".",      function (c) c:move_to_tag()                  end,
