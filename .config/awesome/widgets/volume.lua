...
local utils = require("widgets.volume-ui.utils")


local LIST_DEVICES_CMD = [[sh -c "pacmd list-sinks; pacmd list-sources"]]
-- local GET_VOLUME_CMD = 'pactl list sinks | rg -U "RUNNING(\n..*)*\n.Volume"'
local GET_VOLUME_CMD = 'pactl list sinks'
...
local widget_types = {
    icon_and_text = require("widgets.volume-ui.icon-and-text"),
    icon = require("widgets.volume-ui.icon"),
    arc = require("widgets.volume-ui.arc"),
    horizontal_bar = require("widgets.volume-ui.horizontal-bar"),
    vertical_bar = require("widgets.volume-ui.vertical-bar")
}
...
local function worker(user_args)
    ...
    local refresh_rate = args.refresh_rate or 30
    ...
    local function update_graphic(widget, stdout)
        ...
        local mute = string.match(stdout, "Mute: (%D%D%D?)")
