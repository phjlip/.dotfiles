...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ mod, alt }, "Return", function()
		awful.spawn.with_shell(apps.default.session)
	end, { description = "open session", group = "app" }),
	...
	awful.key({ mod }, "r", function()
		awful.spawn.with_shell(apps.default.app_runner)
	end, { description = "open app launcher", group = "app" }),
	...
	end, { description = "show dashboard panel", group = "hotkeys" }),
...
client.connect_signal("request::default_keybindings", function()
	awful.keyboard.append_client_keybindings({
		...
		--- Sticky
		awful.key({ mod, shift }, "b", function(c)
		...
		end, {description = "close all open clients", group = "client"}),
...
awful.keyboard.append_global_keybindings({
	-- focus
	awful.key({ mod, alt }, "h", function () awful.screen.focus_relative( 1) end,
			{description = "focus the previous screen", group = "screen"}),
	awful.key({ mod, alt }, "l", function () awful.screen.focus_relative(-1) end,
			{description = "focus the next screen", group = "screen"}),
	-- move
	awful.key({ mod, alt, shift }, "h", function () client.focus:move_to_screen(client.focus.screen.index-1) end,
			{description = "focus the previous screen", group = "screen"}),
	awful.key({ mod, alt, shift }, "l", function () client.focus:move_to_screen(client.focus.screen.index+1) end,
			{description = "focus the next screen", group = "screen"}),
})
