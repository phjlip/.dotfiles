...
awful.spawn.easy_async_with_shell("pactl get-sink-volume @DEFAULT_SINK@ | awk '{ print $5}'", function(stdout)
...
volume_slider:connect_signal("property::value", function(_, new_value)
	...
	awful.spawn("pactl set-sink-volume @DEFAULT_SINK@ " .. new_value .. "%", false)
end)
