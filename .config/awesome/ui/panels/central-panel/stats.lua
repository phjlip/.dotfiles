...
local function ram()
	...
	watch('bash -c "free | grep -z Mem.*Swap.*"', 9, function(_, stdout)
...
local function hdd()
	...
	watch([[bash -c "df -h /home|grep '^/' | awk '{print $5}'"]], 17, function(_, stdout)
...
local stats = wibox.widget({
	create_boxed_widget(cpu(), dpi(145), dpi(125), beautiful.one_bg3),
	create_boxed_widget(temperature(), dpi(145), dpi(125), beautiful.one_bg3),
	create_boxed_widget(ram(), dpi(145), dpi(125), beautiful.one_bg3),
	create_boxed_widget(hdd(), dpi(145), dpi(125), beautiful.one_bg3),
	forced_num_cols = 2,
	forced_num_rows = 2,
